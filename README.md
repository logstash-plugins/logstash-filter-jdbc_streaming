...
[![Travis Build Status](https://travis-ci.com/logstash-plugins/logstash-filter-jdbc_streaming.svg)](https://travis-ci.com/logstash-plugins/logstash-filter-jdbc_streaming)

This is a plugin for [Logstash](https://github.com/elastic/logstash).

It is fully free and fully open source. The license is Apache 2.0, meaning you are pretty much free to use it however you want in whatever way.

## JDBC Streaming Filter Plugin Has Moved

This JDBC Streaming Filter Plugin is now a part of the [JDBC Integration Plugin][integration-source];
